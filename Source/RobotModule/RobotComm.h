#ifndef CMANIPULATORINTERFACE_H
#define CMANIPULATORINTERFACE_H
...
class CRobotComm : public QObject
{
    Q_OBJECT
public:
    CRobotComm(CLogModel* log, QObject* parent = 0);
    ~CRobotComm();
...
private:
    ...
    // private function
    void    SendRobotCommand_INIT(QByteArray receiveCommand);
    void    SendRobotCommand_MTRS(QByteArray receiveCommand);
    void    SendRobotCommand_MPNT(QByteArray receiveCommand);
    void    SendRobotCommand_CSRV(QByteArray receiveCommand);
    void    SendRobotCommand_CCLR(QByteArray receiveCommand);
    void    SendRobotCommand_CSOL(QByteArray receiveCommand);
    void    SendRobotCommand_RPOS(QByteArray receiveCommand);
    void    SendRobotCommand_SSPD(QByteArray receiveCommand);
    void    SendRobotCommand_RSTS(/*QByteArray receiveCommand*/);
